...
import { makeRoll } from "./helpers/roll.mjs";
...
async function createRollMacro() {
  // Create the macro command using the uuid.
  return false;
  const name = "Make Roll";
  const command = "game.usr.makeRoll();";
